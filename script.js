document.addEventListener('DOMContentLoaded', () => {
  ...
  // 🎯 四格與三格 PNG 相框的挖孔座標與大小（三格已縮小 0.85 倍並整體往上移約 1 公分 / 38px）
  const FRAME_CONFIGS = {
    4: {
      positions: [
    ...
    3: {
      positions: [
        { left: 21, top: 0, width: 197, height: 187 },
        { left: 21, top: 199, width: 197, height: 196 },
        { left: 21, top: 399, width: 197, height: 191 }
      ]
    }
  };
